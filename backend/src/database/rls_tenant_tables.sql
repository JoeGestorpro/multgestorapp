...
-- WITH CHECK explícito em todas as policies (defesa em profundidade)
...
-- trial_email_log Ã© global (master admin pode ver todas)
-- NÃƒO aplicar RLS

-- ============================================
-- Fase 2 â€” Wallet / PrÃ©-pagamento (PRD-008)
-- ============================================
