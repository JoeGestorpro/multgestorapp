# 📌 Estado do Projeto (V2) — ⛔ SUBSTITUÍDO por `.opencodex/brain/project-state.md`
...
> Ponto de entrada **enxuto** para o Claude Code reduzir leitura de múltiplos arquivos.
...
blocked_tasks:
  ...
  rule: "Tarefas do backlog permanecem bloqueadas até que sua dependência seja auditada e aprovada."
  notable:
...
context_policy:
  purpose: "Reduzir o uso de tokens fornecendo um ponto de entrada de estado único e compacto."
...
notes:
  - "Este arquivo é um índice de estado compacto, não a fonte da verdade para implementação."
  - "Os arquivos da fila permanecem como fonte operacional da verdade."
  - "Os documentos de arquitetura permanecem como fonte estratégica da verdade."
