...
Dados hoje em **Supabase sa-east-1 (Brasil)**. Operar na UE/UK exige base de transferência (SCCs/adequação) e possivelmente residência de dados regional. **Bloqueador real** para UE até resolvido ([[matriz-prontidao-paises]] = Blocked).
...
## Próxima ação
Publicar privacidade/termos/consentimento BR (pré-venda). Qualquer feature de IA: passar por OWASP LLM Top 10 + (se UE) AI Act, com revisão jurídica humana. Registrar decisões em [[registro-decisoes-estrategicas]].

## Links
- [[matriz-prontidao-paises]] · [[motor-futurista-produto]] · [[../living-os/riscos/riscos-ativos|Riscos Ativos]] · [[../../automation/autopilot-policy|Autopilot Policy]]
