...
7. **Termos legais por país** — política de privacidade, termos de uso e consentimento por `country_code` (ver [[compliance-intelligence]]).
...
## Gate
Nada disto entra em execução sem: fundação P1 fechada + decisão humana ([[strategic-decision-log]]). i18n é pré-requisito de **toda** linha "Not Ready" da [[country-readiness-matrix]].

## Links
- [[country-readiness-matrix]] · [[compliance-intelligence]] · [[core-power-map]]
