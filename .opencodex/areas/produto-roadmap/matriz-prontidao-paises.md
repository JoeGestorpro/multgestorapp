...
> Hoje o produto é **pt-BR/BRL single-locale** → nenhum país está "Ready" até a i18n base existir ([[requisitos-internacionalizacao]]).
...
1. i18n base implementada ([[requisitos-internacionalizacao]]).
2. Multi-currency + gateway local.
3. Regime de privacidade do país coberto ([[inteligencia-conformidade]]).
4. Suporte no idioma/fuso.
5. Decisão humana registrada em [[registro-decisoes-estrategicas]].
...
## Links
- [[radar-mercado-global]] · [[requisitos-internacionalizacao]] · [[inteligencia-conformidade]]
