...
> **Método:** rubrica do [[arquiteto-visao-global]] §7 (1–5 por dimensão). Risco/compliance entram invertidos.
> **Confiança:** média (fit/reuso = alta evidência via [[mapa-forca-core]]; receita/mercado = estimativa).
> **Regra:** cada nicho diz qual capability do Core fortalece. Expansão internacional → [[matriz-prontidao-paises]].
...
## Gate
Nenhum nicho novo deve sair de "estudar/incubar" antes de: (1) fundação P1 fechada ([[../production-readiness|readiness]]); (2) `core-vs-vertical-boundary-map` publicado; (3) decisão humana registrada em [[registro-decisoes-estrategicas]].

## Links
- [[mapa-forca-core]] · [[motor-futurista-produto]] · [[matriz-prontidao-paises]] · [[registro-decisoes-estrategicas]]
