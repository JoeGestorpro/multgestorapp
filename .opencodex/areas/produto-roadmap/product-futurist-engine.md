...
> **Método:** cruzar capacidades **reais** do Core ([[core-power-map]]) para gerar ideias. Cada ideia diz qual capability fortalece, recebe classificação ([[global-vision-architect]] §8) e confiança.
...
| Agenda + WhatsApp + IA (LLM) | **IA recepcionista** (agenda/responde via WhatsApp) | Integração, IA | estudar (passa por [[compliance-intelligence]]) | baixa |
...
5. **IA recepcionista** — fortalece Integração + IA. *Estudar* — **obrigatório** passar por OWASP LLM Top 10 + (UE) AI Act ([[compliance-intelligence]]). Baixa.
...
- Ideias com IA marcadas para [[compliance-intelligence]] ✅
...
## Gate
Toda ideia "executar agora"/"roadmap" só avança via decisão humana registrada em [[strategic-decision-log]] e (se operacional) encaminhada à [[../living-os/decisoes/decisoes-executivas|Decisões Executivas]]. **Fundação P1 primeiro.**

## Links
- [[core-power-map]] · [[niche-radar]] · [[compliance-intelligence]] · [[strategic-decision-log]] · [[global-benchmark-memory]]
