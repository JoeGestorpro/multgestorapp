...
> **Relacionamentos:** [[constituicao]] · [[constitution-knowledge-os]] · [[memoria]] · [[saude]] · [[technical/README]]
...
|---|---|---|
| Uma missão por vez | Sempre | [[constituicao]] |
| Stage seletivo | Nunca `git add -A` | [[constituicao]] |
| Push só com confirmação humana | Aprovação requerida | [[constituicao]] |
| CHECK 0 pré-missão | Score ≥ 95 para executar | [[confianca-contexto]] |
| Loop de fechamento pós-missão | Atualizar Knowledge OS | [[ops/mission-closing-protocol]] |
| Rota exposta = proteção obrigatória | 4 perguntas de abuso | [[constituicao]] (Art. 7) |
...
- [[constituicao]] — Regras invioláveis do produto
- [[constitution-knowledge-os]] — Regras do Knowledge OS
- [[memoria]] — Memória evolutiva
