...
**Resposta rápida:**
- Consulte [[linha-do-tempo]] — cada evento lista PRs relacionados
- Ou [[implementacao-log]] — registro detalhado por implementação

### 5. "Qual deploy publicou isso?"

**Resposta rápida:**
- Consulte [[linha-do-tempo]] — cada evento lista o deploy
- Ou [[status-dinamico#Últimos Deploys]]
...
| O que falta? | Maturity 57/100, Core 52/100, ~10/14 prod | [[saude]] |
| Por que decidimos isso? | ADR-XX, D-XXX ou consultar DECISION-GRAPH | [[decisions/DECISION-GRAPH]] |
| Qual PR mudou isso? | PR #[número] em [[linha-do-tempo]] | [[linha-do-tempo]] |
| Qual deploy publicou isso? | Deploy em [[linha-do-tempo]] | [[linha-do-tempo]] |
...
│  [[grafo-conhecimento]] — Relacionamentos explícitos               │
├──────────────────────────────────────────────────────────────────┤
│                     7 CAMADAS LÓGICAS                             │
...
│  [[constitution-knowledge-os]] · [[constituicao]] · [[rules]]     │
│  [[confianca-contexto]] · [[ops/mission-closing-protocol]] │
└──────────────────────────────────────────────────────────────────┘
```
