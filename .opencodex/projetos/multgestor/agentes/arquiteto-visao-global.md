...
## 5. Como pensa
1. Parte do **Core real** ([[mapa-forca-core]]) — só capacidades comprovadas no `capabilities-map`.
2. Cruza capacidades para gerar ideias ([[motor-futurista-produto]]).
3. Filtra por fit com Core, receita, velocidade, reutilização, risco, compliance ([[radar-nichos]]).
4. Para expansão geográfica, passa por [[radar-mercado-global]] → [[matriz-prontidao-paises]] → [[requisitos-internacionalizacao]].
5. Para qualquer ideia com IA, passa por [[inteligencia-conformidade]].
6. Registra aprendizados externos em [[memoria-benchmark-global]] e decisões em [[registro-decisoes-estrategicas]].
...
2. Toda expansão internacional passa pela [[matriz-prontidao-paises]].
3. Toda ideia com IA passa pela [[inteligencia-conformidade]].
...
## Links
- [[mapa-forca-core]] · [[radar-nichos]] · [[motor-futurista-produto]] · [[registro-decisoes-estrategicas]] · [[../living-os/README|Living OS]]
