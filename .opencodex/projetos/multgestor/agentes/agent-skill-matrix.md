...
> **Relacionamentos:** [[agents/README]] · [[prompts/README]]
...
|---|---|---|---|---|
| [[product-manager]] | customize-opencode, find-skills | 1 | Visão de produto, roadmap, mercado | Brain → product/ → nichos/ |
| [[product-owner]] | — | 2 | PRDs, critérios de aceite, fluxos | product/ → technical/ |
| [[platform-architect]] | customize-opencode, supabase | 1 | Arquitetura, decisões técnicas | technical/ → decisions/ |
| [[frontend-specialist]] | — | 1 | UI/UX, componentes React | technical/frontend → maps/ |
| [[database-architect]] | supabase | 1 | Schema, migrations, RLS | technical/banco → maps/ |
| [[qa]] | — | 3 | Testes, qualidade, regressão | technical/ → incidents/ |
| [[security]] | — | 1 | Segurança, compliance, RLS | technical/seguranca → rules/ |
...
- [[prompts/README]] — Biblioteca de prompts
