...
| --- | --- | --- |
| Backend Render | https://multgestor-backend.onrender.com | ✅ healthy |
| Frontend Vercel | https://barbergestor.com.br / https://multgestorapp.com.br | ✅ presumido (build CI passa) |
| Supabase produção | sa-east-1, project `mfayajizbkqkcbhqmean` | ✅ ACTIVE_HEALTHY |
...
```
GET https://multgestor-backend.onrender.com/api/health/deep
...
- `frontend/.env.production`: `VITE_API_URL=https://multgestor-backend.onrender.com` ✅ (único arquivo .env tracked — exceção intencional no .gitignore)
