...
## ADR-10 — Skills Supabase rejeitadas
**Contexto:** PR #5 propunha instalar 40 skills Supabase em `.agents/skills/`. Verificação mostrou que o diretório `.agents/skills/` não existe no repo — o padrão é `.agent/skills/`. Além disso, o PR estava 67 commits atrás de main e os skills já estavam desatualizados. **Decisão:** fechar PR #5 como obsoleto. Skills Supabase existentes em `.agent/skills/` já cobrem o essencial. **Status: vigente (2026-07-15).**
