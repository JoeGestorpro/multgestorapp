...
> **Relacionamentos:** [[decisions/README]] · [[decisions/DECISION-GRAPH]] · [[linha-do-tempo]] · [[status-dinamico]]
...
### Riscos / Follow-up
- Mudança de **dado em produção** (não versionada em código). Registrada aqui e no [[linha-do-tempo]] e na memória `project-joefelipe-plan-premium`.
