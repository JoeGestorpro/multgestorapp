...
|---|---|---|
| **Homepage** | [[00-HOME]] | 🏠 |
| **Estado Atual** | [[01-CURRENT-STATE]] | 2 |
| **Dashboard Executivo** | [[02-EXECUTIVE-DASHBOARD]] | 2 |
| **Timeline** | [[03-TIMELINE]] | 7 |
| **Índice Geral** | [[INDEX]] | 🏠 |
...
| **Knowledge Graph** | [[KNOWLEDGE-GRAPH]] | 7 |
...
| [[constitution]] | Princípios e regras invioláveis (produto/engenharia) |
| [[constitution-knowledge-os]] | Princípios e regras do Knowledge OS |
| [[project-state]] | Estado atual real — atualizado a cada APPROVE |
| [[capabilities-map]] | Capabilities do Core e seu status |
| [[architecture-decisions]] | ADRs vinculantes |
| [[implementation-log]] | Registro cronológico do que foi implementado |
| [[lessons-learned]] | Incidentes e aprendizados |
| [[context-confidence-engine]] | Como toda missão mede se tem contexto suficiente |
...
- [[KNOWLEDGE-GRAPH]] — Mapa de relacionamentos
