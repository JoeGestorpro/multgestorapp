...
**Não, para venda para cliente pagante.** 8 dos 14 critérios de produção segura não estão atendidos. A Camada 1 (Fundação Segura) precisa ser fechada.
...
- [ ] Backup com cópia externa ativa — **A-002**
...
| A-002 | Backup sem cópia externa | Perda catastrófica de dados | `ops/backup-external-copy` |
...
```
ops/backup-external-copy (P1)
  → security/rls-companies-users-policy (P1)
